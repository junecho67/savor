...
const imgShare = '/savor/share.svg'
const imgSettings = '/savor/settings.svg'
...
const imgTopProfile = '/savor/images-2.jpeg'
const imgGrandma = '/savor/grandma.png'
const imgMom = '/savor/mom.png'
const imgDad = '/savor/dad.png'
const imgCousin = '/savor/cousinian.png'

const imgSavedRibs = '/savor/ribs.png'
const imgSavedPasta = '/savor/pasta.png'

const imgPost1 = '/savor/cho curry.jpg'
const imgPost2A = '/savor/butterpasta.png'
const imgPost2B = '/savor/butter.png'
const imgPost3 = '/savor/cookie.png'
const imgOtherMom = '/savor/jangfamily.png'
const imgOtherDad = '/savor/dad from jang family.png'
const imgOtherPost1 = '/savor/momfromhongfood.png'
const imgOtherPost2 = '/savor/mapotofu.png'
